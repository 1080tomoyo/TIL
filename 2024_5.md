...
- フォロー機能の追加<br>
  ...
  - フォロー中かどうかを判定するメソッドの作成<br>
    ...
    &emsp;<img width="500" alt="スクリーンショット 2024-05-28 5 20 22" src="https://github.com/1080tomoyo/TIL/assets/143313394/119a1a47-e998-4734-a154-baae62d12dba">
  - フォロー機能のルーティングの追加<br>
  - コントローラーへアクションメソッドの追加<br>
  - ユーザーモデルへリレーションメソッドの追加<br>
  - フォロー・フォロー解除の非同期通信を行うようにする(下に動画)<br>
  - 未ログイン状態での制御<br>
